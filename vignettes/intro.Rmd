...
Another way to publish a profvis visualization is to save the HTML output file and put that on any web hosting service. You can save it from your web browser, or you can use `htmlwidgets::saveWidget`:
